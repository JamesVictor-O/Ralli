...
export const demoRallis: Dare[] = [
  {
    id: 'desk', author: 'Nia', initials: 'NK', authorAvatarUrl: null, time: '8 min',
    ...
    imageAlt: 'A creative desk filled with stationery and small objects', mediaType: 'image', tone: 'coral',
  },
  {
    id: 'sky', author: 'Milo', initials: 'MO', authorAvatarUrl: null, time: '23 min',
    ...
    imageAlt: 'A dramatic pastel sky over a distant landscape', mediaType: 'image', tone: 'violet',
  },
]
