...
export const demoRallis: Dare[] = [
  {
    ...
    participants: 84, reactions: 192, passes: 17, reward: 12, starterReward: 5, boosts: 7,
  ...
  },
  {
    ...
    participants: 341, reactions: 628, passes: 46, reward: 24, starterReward: 10, boosts: 14,
